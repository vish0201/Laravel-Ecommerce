...
@section('content')
    <div class="container w-50 bg-light mt-5 p-4 rounded-4 shadow position-relative"
        style="background-color: #EEF7FF; color: #4D869C;">
            ...
            <div class="tab-pane fade show active" id="pills-register" role="tabpanel" aria-labelledby="tab-register">
                <form action="{{ route('register.submit') }}" method="POST">
                        ...
                        <div class="col-md-6">
                            <div data-mdb-input-init class="form-outline mb-3">
                                <input type="password" id="registerRepeatPassword" name="registerPassword_confirmation"
                                    class="form-control" style="border-color: #7AB2B2;" />
                    ...
                    <div class="d-flex justify-content-center">
                        <button type="submit" class="btn btn-primary form-control w-50 mb-3"
                            style="background-color: #4D869C; border-color: #4D869C;">Register</button>
                    </div>

                    <div class="text-center">
                        <p>Already have an account? <a href="{{ route('user.login') }}" style="color: #007bff;">Login</a>
                        </p>
                    </div>
                </form>
